  ...
  <div class="body">
	...
	<g:form method="post" >
	  ...
	  <div class="dialog">
		...
		<div class="prop">
		  <span class="name">
			<label for="startDate"><g:message code="instrumentHistory.startDate.label" default="Start Date" /></label>
		  </span>
		  <span class="value ${hasErrors(bean: instrumentHistoryInstance, field: 'startDate', 'errors')}">
			<g:datePicker name="startDate" precision="day" value="${instrumentHistoryInstance?.startDate}"  />
		  </span>
		</div>
		...
		<div class="prop">
		  ...
		  <span class="value ${hasErrors(bean: instrumentHistoryInstance, field: 'comments', 'errors')}">
			<g:textArea name="comments" value="${instrumentHistoryInstance?.comments}" rows="5" cols="40" />
		  </span>
		</div>
	  ...
	  <div class="buttons">
		...
		<span class="button"><g:actionSubmit class="show" action="show" value="${message(code: 'default.button.cancel.label', default: 'Cancel')}" /></span>
		<span class="button"><g:actionSubmit class="show" action="retire" value="${message(code: 'default.button.retire.label', default: 'Retire')}" /></span>
	  </div>
	</g:form>
  </div>
</body>
