...
<html>
  ...
  <g:set var="entityName" value="${message(code: 'instrumentHistory.label', default: 'Instrument Revision')}" />
  ...
  <div class="body">
	...
	<div class="list">
	  <table>
		...
		<th><g:message code="instrumentHistory.itemVersion.label" default="Version" /></th>
		...
		<th><g:message code="instrumentHistory.dateCreated.label" default="Created" /></th>
