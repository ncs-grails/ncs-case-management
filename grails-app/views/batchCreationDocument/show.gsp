	...
	<tbody>
		...
		<tr class="prop">
			<td valign="top" class="name"><g:message
				code="batchCreationDocument.id.label" default="Id" /></td>
		...
		<tr class="prop">
			<td valign="top" class="name"><g:message
				...
				default="Batch Creation Config" /></td>

			<td valign="top" class="value"><g:link
				controller="batchCreationConfig" action="show"
				id="${batchCreationDocumentInstance?.batchCreationConfig?.id}">
				${batchCreationDocumentInstance?.batchCreationConfig?.encodeAsHTML()}
			</g:link></td>
