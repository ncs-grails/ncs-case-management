    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${instrumentApprovalInstance?.version}" />
                <div class="dialog">
                        
                            <div class="prop">
                                <span class="name">
                                  <label for="instrumentHistory"><g:message code="instrumentApproval.instrumentHistory.label" default="Instrument History" /></label>
                                </span>
                                <span class="value ${hasErrors(bean: instrumentApprovalInstance, field: 'instrumentHistory', 'errors')}">
                                    <g:select name="instrumentHistory.id" from="${edu.umn.ncs.InstrumentHistory.list()}" optionKey="id" value="${instrumentApprovalInstance?.instrumentHistory?.id}"  />
                                </span>
                            </div>
                            ...
                            <div class="prop">
                                ...
                                <span class="value ${hasErrors(bean: instrumentApprovalInstance, field: 'comments', 'errors')}">
                                    <g:textField name="comments" value="${instrumentApprovalInstance?.comments}" />
                                </span>
                            </div>
                        
                            <div class="prop">
                                <span class="name">
                                  <label for="userCreated"><g:message code="instrumentApproval.userCreated.label" default="User Created" /></label>
                                </span>
                                <span class="value ${hasErrors(bean: instrumentApprovalInstance, field: 'userCreated', 'errors')}">
                                    <g:textField name="userCreated" value="${instrumentApprovalInstance?.userCreated}" />
                                </span>
                            </div>
                        
                            <div class="prop">
                                <span class="name">
                                  <label for="appCreated"><g:message code="instrumentApproval.appCreated.label" default="App Created" /></label>
                                </span>
                                <span class="value ${hasErrors(bean: instrumentApprovalInstance, field: 'appCreated', 'errors')}">
                                    <g:textField name="appCreated" value="${instrumentApprovalInstance?.appCreated}" />
                                </span>
                            </div>
                        
                            <div class="prop">
                                <span class="name">
                                  <label for="userUpdated"><g:message code="instrumentApproval.userUpdated.label" default="User Updated" /></label>
                                </span>
                                <span class="value ${hasErrors(bean: instrumentApprovalInstance, field: 'userUpdated', 'errors')}">
                                    <g:textField name="userUpdated" value="${instrumentApprovalInstance?.userUpdated}" />
                                </span>
                            </div>
