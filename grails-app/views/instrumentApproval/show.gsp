...
<div class="prop"><span class="name">Approved Item</span> <span
	class="value"> <g:link controller="instrumentHistory"
	action="show" id="${instrumentApprovalInstance?.instrumentHistory?.id}">
...
<div class="prop"><span class="name"><g:message
	code="instrumentApproval.approvalDate.label" default="Approval Date" /></span>

<span class="value"><g:formatDate
	date="${instrumentApprovalInstance?.approvalDate}" format="yyyy-MM-dd" /></span>

</div>

<div class="prop"><span class="name"><g:message
	code="instrumentApproval.approvedBy.label" default="Approved By" /></span> <span
	class="value">
${fieldValue(bean: instrumentApprovalInstance, field: "approvedBy")}
</span></div>

<div class="prop"><span class="name"><g:message
	code="instrumentApproval.approvalType.label" default="Approval Type" /></span>

<span class="value">
${instrumentApprovalInstance?.approvalType?.encodeAsHTML()}
</span></div>

<fieldset class="maroonBorder"><legend
	style="margin-left: 0.5em;"><g:message
	code="instrumentApproval.comments.label" default="Comments" /></legend> <span
	class="value">
${fieldValue(bean: instrumentApprovalInstance, field: "comments")}
</span></fieldset>

<fieldset class="maroonBorder"><legend
	style="margin-left: 0.5em;">Provenance Data</legend> Created by ${fieldValue(bean: instrumentApprovalInstance, field: "userCreated")}
...
<g:if test="${instrumentApprovalInstance?.userUpdated}">
							...
							on <g:formatDate
		date="${instrumentApprovalInstance?.lastUpdated}" />
</g:if></fieldset>
