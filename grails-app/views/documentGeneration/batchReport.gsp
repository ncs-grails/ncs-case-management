  ...
  <body>
	...
	<!-- PRIMARY BATCH INFORMATION -->
	  ...
	  <!-- CHILD / SISTER BATCHES -->
          ...
          <g:each var="b" in="${batchInstance?.creationConfig?.batches}"
            <div class="dataitem">
              <div class="datavalue w50"><span class="instrument">primary instruments: ${b?.primaryInstrument?.name}</span></div>
            </div>
          <div class="clear"></div>
          </g:each>
