...
<html>
  ...
  <div style="border-bottom: thin solid black; color: maroon; font-variant: small-caps; font-size: 1.5em;" >
    University of Minnesota
  </div>
  <div style="clear:both;">
    <div class="letterheadBlock" style="font-weight: bold; margin-left: 7em; text-align: center;">
    ...
    <p id="mailingAddress">
      ...
      <span class="zipCode">55455</span>-<span class="zip4">2008</span><br/>
      <span class="mcode b"># 2004</span>
    </p>

    <hr/>

    <div class="dataitem">
      <div class="datavalue w50"><span class="b" id="studyName">${batchInstance?.primaryInstrument?.study?.name}</span></div>
      <div class="datavalue w50"><span class="b" id="primaryInstrument">${batchInstance?.primaryInstrument?.name}</span></div>
    </div>
    <div class="clear"></div>
