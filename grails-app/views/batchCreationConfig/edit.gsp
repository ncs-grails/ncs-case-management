                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="archivedQueries"><g:message code="batchCreationConfig.archivedQueries.label" default="Archived Queries" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: batchCreationConfigInstance, field: 'archivedQueries', 'errors')}">
...
<g:link controller="batchCreationQueryArchive" action="create" params="['batchCreationConfig.id': batchCreationConfigInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'batchCreationQueryArchive.label', default: 'BatchCreationQueryArchive')])}</g:link>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="documents"><g:message code="batchCreationConfig.documents.label" default="Documents" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: batchCreationConfigInstance, field: 'documents', 'errors')}">
...
<g:link controller="batchCreationDocument" action="create" params="['batchCreationConfig.id': batchCreationConfigInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'batchCreationDocument.label', default: 'BatchCreationDocument')])}</g:link>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="subItems"><g:message code="batchCreationConfig.subItems.label" default="Sub Items" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: batchCreationConfigInstance, field: 'subItems', 'errors')}">
...
<g:link controller="batchCreationItem" action="create" params="['batchCreationConfig.id': batchCreationConfigInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'batchCreationItem.label', default: 'BatchCreationItem')])}</g:link>
