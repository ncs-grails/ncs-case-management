...
<g:hasErrors bean="${dwellingUnitInstance}">
	<div class="errors"><g:renderErrors
		bean="${dwellingUnitInstance}" as="list" /></div>
</g:hasErrors>
...
<g:form class="ncs" action="quickAdd">
	...
	<g:textField name="address.address"
		value="${dwellingUnitInstance?.address?.address}" />

	<label for="address.address">City</label>
	<g:textField name="address.city"
		value="${dwellingUnitInstance?.address?.city}" />

	<label for="address.state">State</label>
	<g:textField name="address.state"
		value="${dwellingUnitInstance?.address?.state}" />

	<label for="address.zipCode">Zip code</label>
	<g:textField name="address.zipCode"
		value="${dwellingUnitInstance?.address?.zipCode}" />

	<label for="address.zipCode">Zip code</label>
	<g:textField name="address.zip4"
		value="${dwellingUnitInstance?.address?.zip4}" />
